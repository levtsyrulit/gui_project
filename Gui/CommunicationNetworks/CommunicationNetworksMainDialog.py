...
from .CommunicationNetworksAdditionalDialog import CommunicationNetworksAdditionalDialog
...
from ...Models.CommunicationNetworksModel import CommunicationNetworksModel
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'CommunicationNetworksMainDialog.ui'))

class CommunicationNetworksMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.CommunicationNetworks
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode=DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(CommunicationNetworksMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = CommunicationNetworksModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        if signal == False:
            ...
            self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11V.getElements())
            self.dictionaryComboBoxHelper.setItems(self.cbCommunicationNetworkStructureType, ds.Dictionary11W.getElements())
    ...
    def __setReadOnly(self, readOnly=False): 
        ...
        self.cbCommunicationNetworkStructureType.setEnabled(not readOnly)
    ...
    def __fillModel(self):
        ...
        self.model.communicationNetworkStructureType = self.dictionaryComboBoxHelper.getKeyStringForSelectedElements(self.cbCommunicationNetworkStructureType)
    ...
    def __initFields(self):
        ...
        self.dictionaryComboBoxHelper.setSelectedElementsFromKeyString(self.cbCommunicationNetworkStructureType, self.model.communicationNetworkStructureType)
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = CommunicationNetworksAdditionalDialog(self.model, self.mode, self)
