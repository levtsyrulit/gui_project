...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'LiquidHydrocarbonsObjectsAdditionalDialog.ui'))

class LiquidHydrocarbonsObjectsAdditionalDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, model, mode=DlgMode.VIEW, parent=None):
        """Constructor."""
        super(LiquidHydrocarbonsObjectsAdditionalDialog, self).__init__(parent)
