...
from ...Models.WaterSupplyObjectsModel import WaterSupplyObjectsModel
from ...Gui.ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .WaterSupplyObjectsAdditionalAttributesDialog import WaterSupplyObjectsAdditionalAttributesDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WaterSupplyObjectsMainDialog.ui'))

class WaterSupplyObjectsMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.WaterSupplyObjects
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode = DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(WaterSupplyObjectsMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = WaterSupplyObjectsModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        if signal == False:
            ...
            self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11I.getSpecificElements(
                ["11I.0","11I.1", "11I.2", "11I.3", "11I.4"]))
            self.dictionaryComboBoxHelper.setItems(self.cbArrangement, ds.Dictionary11F.getElements())
            self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures,
                                                   ds.DictionaryCT23.getSpecificElements(["CT23.1"]))
    ...
    def __checkAddictionalStructuresEnable(self):
        ...
        self.additionalStructuresIsSelected = item and item.name == "11I.0"
    ...
    def __initFields(self):
        ...
        self.dictionaryComboBoxHelper.setSelectedElementsFromKeyString(self.cbAdditionalStructures,self.model.additionalStructures)
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = WaterSupplyObjectsAdditionalAttributesDialog(self.model, self.mode, self)
