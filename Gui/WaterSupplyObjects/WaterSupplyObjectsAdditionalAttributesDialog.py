...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WaterSupplyObjectsAdditionalDialog.ui'))

class WaterSupplyObjectsAdditionalAttributesDialog(QtWidgets.QDialog, FORM_CLASS):
    mode = DlgMode.VIEW

    def __init__(self, model, mode = DlgMode.VIEW, parent=None):
        """Constructor."""
        super(WaterSupplyObjectsAdditionalAttributesDialog, self).__init__(parent)
