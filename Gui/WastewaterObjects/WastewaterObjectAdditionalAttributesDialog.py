...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WastewaterObjectAdditionalDialog.ui'))

class WastewaterObjectAdditionalAttributesDialog(QtWidgets.QDialog, FORM_CLASS):
    mode = DlgMode.VIEW

    def __init__(self, model, mode = DlgMode.VIEW, parent=None):
        """Constructor."""
        super(WastewaterObjectAdditionalAttributesDialog, self).__init__(parent)
