...
from ...Models.WastewaterObjectModel import WastewaterObjectModel
from ...Gui.ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .WastewaterObjectAdditionalAttributesDialog import WastewaterObjectAdditionalAttributesDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WastewaterObjectMainDialog.ui'))

class WastewaterObjectMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.WastewaterObjects
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode = DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(WastewaterObjectMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = WastewaterObjectModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        if signal == False:
            ...
            self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11H.getElementsExcept("11H.4"))
            ...
            self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures,
                                                   ds.DictionaryCT22.getSpecificElements(["CT22.1", "CT22.2", "CT22.7"]))
    ...
    def __checkAddictionalStructuresEnable(self):
        ...
        self.additionalStructuresIsSelected = item and item.name == "11H.0"
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = WastewaterObjectAdditionalAttributesDialog(self.model, self.mode, self)
