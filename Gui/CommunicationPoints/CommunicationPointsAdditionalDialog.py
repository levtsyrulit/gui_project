...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'CommunicationPointsAdditionalDialog.ui'))

class CommunicationPointsAdditionalDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, model, mode=DlgMode.VIEW, parent=None):
        """Constructor."""
        super(CommunicationPointsAdditionalDialog, self).__init__(parent)
