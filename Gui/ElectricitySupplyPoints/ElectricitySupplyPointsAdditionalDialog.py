...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ElectricitySupplyPointsAdditionalDialog.ui'))

class ElectricitySupplyPointsAdditionalDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, model, mode=DlgMode.VIEW, parent=None):
        """Constructor."""
        super(ElectricitySupplyPointsAdditionalDialog, self).__init__(parent)
