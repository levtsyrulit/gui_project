...
from ...Models.ElectricitySupplyPointsModel import ElectricitySupplyPointsModel
from ..ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .ElectricitySupplyPointsAdditionalDialog import ElectricitySupplyPointsAdditionalDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'ElectricitySupplyPointsMainDialog.ui'))

class ElectricitySupplyPointsMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.ElectricitySupplyPoints
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode=DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(ElectricitySupplyPointsMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = ElectricitySupplyPointsModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11P.getSpecificElements(["11P.0","11P.28"]))
        self.dictionaryComboBoxHelper.setItems(self.cbArrangement, ds.Dictionary11F.getElements())
        self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures, ds.DictionaryCT27.getElementsExcept(["CT27.8"]))
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = ElectricitySupplyPointsAdditionalDialog(self.model, self.mode, self)
