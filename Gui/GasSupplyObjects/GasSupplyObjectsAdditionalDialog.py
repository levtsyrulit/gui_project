...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'GasSupplyObjectsAdditionalDialog.ui'))

class GasSupplyObjectsAdditionalDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, model, mode=DlgMode.VIEW, parent=None):
        """Constructor."""
        super(GasSupplyObjectsAdditionalDialog, self).__init__(parent)
