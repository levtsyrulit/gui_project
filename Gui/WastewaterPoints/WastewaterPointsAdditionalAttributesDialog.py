...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WastewaterPointsAdditionalDialog.ui'))

class WastewaterPointsAdditionalAttributesDialog(QtWidgets.QDialog, FORM_CLASS):
    mode = DlgMode.VIEW

    def __init__(self, model, mode = DlgMode.VIEW, parent=None):
        """Constructor."""
        super(WastewaterPointsAdditionalAttributesDialog, self).__init__(parent)
