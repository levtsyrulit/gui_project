...
from ...Models.WastewaterPointsModel import WastewaterPointsModel
from ...Gui.ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .WastewaterPointsAdditionalAttributesDialog import WastewaterPointsAdditionalAttributesDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WastewaterPointsMainDialog.ui'))

class WastewaterPointsMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.WastewaterPoints
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode = DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(WastewaterPointsMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = WastewaterPointsModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11H.getSpecificElements(["11H.0", "11H.4"]))
        self.dictionaryComboBoxHelper.setItems(self.cbArrangement, ds.Dictionary11F.getElements())
        self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures, ds.DictionaryCT22.getElementsExcept(["CT22.1", "CT22.2", "CT22.7"]))
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = WastewaterPointsAdditionalAttributesDialog(self.model, self.mode, self)
