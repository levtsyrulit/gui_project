...
from ...Models.HeatSupplyPointsModel import HeatSupplyPointsModel
from ..ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .HeatSupplyPointsAdditionalDialog import HeatSupplyPointsAdditionalDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'HeatSupplyPointsMainDialog.ui'))

class HeatSupplyPointsMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.HeatSupplyPoints
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode=DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(HeatSupplyPointsMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = HeatSupplyPointsModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11N.getSpecificElements(["11N.0", "11N.5", "11N.7"]))
        self.dictionaryComboBoxHelper.setItems(self.cbArrangement, ds.Dictionary11F.getElements())
        self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures, ds.DictionaryCT25.getElementsExcept(["CT25.1", "CT25.4"]))
        self.__initFields()
    ...
    def __checkAddictionalStructuresEnable(self):
        ...
        self.additionalStructuresIsSelected = item and item.name == "11N.0"
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = HeatSupplyPointsAdditionalDialog(self.model, self.mode, self)
