...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'HeatSupplyPointsAdditionalDialog.ui'))

class HeatSupplyPointsAdditionalDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, model, mode=DlgMode.VIEW, parent=None):
        """Constructor."""
        super(HeatSupplyPointsAdditionalDialog, self).__init__(parent)
