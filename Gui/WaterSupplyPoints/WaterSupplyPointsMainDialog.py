...
from ...Models.WaterSupplyPointsModel import WaterSupplyPointsModel
from ...Gui.ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .WaterSupplyPointsAdditionalAttributesDialog import WaterSupplyPointsAdditionalAttributesDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'WaterSupplyPointsMainDialog.ui'))

class WaterSupplyPointsMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.WaterSupplyPoints
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode = DlgMode.VIEW, parent=None, feature=None):
        """Constructor."""
        super(WaterSupplyPointsMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = WaterSupplyPointsModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        self.dictionaryComboBoxHelper.setItems(self.cbObjectType,
                                                ds.Dictionary11I.getSpecificElements(["11I.0", "11I.5", "11I.6", "11I.7"]))
        self.dictionaryComboBoxHelper.setItems(self.cbArrangement, ds.Dictionary11F.getElements())
        self.dictionaryComboBoxHelper.setItems(self.cbAdditionalStructures, ds.DictionaryCT23.getElementsExcept(["CT23.1"]))
    ...
    def __createFeatureFromModel(self, layer: QgsMapLayer):
        ...
        # Заполнение атрибутов из модели данных
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = WaterSupplyPointsAdditionalAttributesDialog(self.model, self.mode, self)
