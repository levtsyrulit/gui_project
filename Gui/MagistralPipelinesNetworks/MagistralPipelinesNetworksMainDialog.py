...
from ...Models.MagistralPipelinesNetworksModel import MagistralPipelinesNetworksModel
from ..ObjectPassport.ObjectPassportDialog import ObjectPassportDialog
from .MagistralPipelinesNetworksAdditionalDialog import MagistralPipelinesNetworksAdditionalDialog
...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'MagistralPipelinesNetworksMainDialog.ui'))

class MagistralPipelinesNetworksMainDialog(QtWidgets.QDialog, FORM_CLASS):
    LAYERNAME = LayerNames.MagistralPipelinesNetworks
    closingDlg = pyqtSignal()

    def __init__(self, iface, mode=DlgMode.VIEW, parent=None, feature = None):
        """Constructor."""
        super(MagistralPipelinesNetworksMainDialog, self).__init__(parent)
        ...
        self.mapTool = None
        self.model = MagistralPipelinesNetworksModel()
        self.layer = None
        self.points = []
        self.mode = mode
        ...
        if signal == False:
            ...
            self.dictionaryComboBoxHelper.setItems(self.cbObjectType, ds.Dictionary11E.getElements())
    ...
    def __openAdditionalAttributesDlg(self):
        dlgAdditionalAttributes = MagistralPipelinesNetworksAdditionalDialog(self.model, self.mode, self)
