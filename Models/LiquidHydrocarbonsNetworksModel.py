...
class LiquidHydrocarbonsNetworksModel(ModelBase):
    def __init__(self):
    ...
    def fillFeatureFromModel(self, feature):
        ...
        feature.setAttribute("SpecialPurposePipeline", self.specialPurposePipeline)
    ...
    def fillModelFromFeature(self, feature):
        ...
        self.constructions  = feature["Constructions"] or 0.0
        self.undergroundLaying  = feature["UndergroundLaying"] or 0.0
        self.materialCT4  = feature["MaterialCT4"] or 0.0
        self.specialPurposePipeline  = feature["SpecialPurposePipeline"] or 0.0
